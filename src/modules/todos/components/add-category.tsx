	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				<Button type="button" variant="ghost" size="sm" className="w-full justify-start px-2 py-1.5 h-auto font-normal">
								...
								<FormItem>
									...
									<FormControl>
										<div className="flex items-center space-x-2">
											<Input type="color" className="w-16 h-10 p-1 rounded cursor-pointer" {...field} />
											<Input type="text" placeholder="#6366f1" className="flex-1" {...field} />
										</div>
									</FormControl>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormControl>
										<Textarea placeholder="Enter category description..." className="resize-none" rows={3} {...field} />
									</FormControl>
