	...
	const handleDelete = () => {
		startTransition(async () => {
			try {
				...
				alert(`Error deleting todo: ${error instanceof Error ? error.message : 'Unknown error'}`);
			}
		});
	};
		...
		<AlertDialog open={isOpen} onOpenChange={setIsOpen}>
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogDescription>This action cannot be undone. This will permanently delete this todo.</AlertDialogDescription>
				</AlertDialogHeader>
				<AlertDialogFooter>
